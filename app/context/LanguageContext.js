...
export const translations = {
  fr: {
    ...
    archives: {
      ...
      description: "Tous mes autres projets : exercices, apprentissages et travaux annexes qui ont jalonné mon parcours.",
      backToHome: "Retour à l'accueil",
      webApps: 'Projets web & applicatifs',
      webAppsDesc: 'Interfaces, applications frontend/backend et projets fullstack.',
      data: 'Projets data & analyse',
      dataDesc: 'Analyse de données, dashboards, SQL, Excel, Power BI et reporting.',
      learning: "Projets d'apprentissage",
      learningDesc: "Mes premiers projets d'apprentissage HTML/CSS/JS.",
      empty: 'Aucun projet archivé pour le moment.',
    },
    contact: {
      title: 'Contactez-moi',
  ...
  en: {
    ...
    archives: {
      ...
      description: 'All my other projects: exercises, learning work and side projects along the way.',
      backToHome: 'Back to home',
      webApps: 'Web & App Projects',
      webAppsDesc: 'Interfaces, frontend/backend apps and fullstack projects.',
      data: 'Data & Analytics Projects',
      dataDesc: 'Data analysis, dashboards, SQL, Excel, Power BI and reporting.',
      learning: 'Learning Projects',
      learningDesc: 'My earliest HTML/CSS/JS learning projects.',
